...
assert.match(mainRust, /tauri::generate_handler!\[[\s\S]*?get_cached_agent_projects,[\s\S]*?discover_agent_projects,/, "both cached restore and explicit refresh commands must be registered with Tauri");
