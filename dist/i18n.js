  ...
  const translations = {
    "zh-CN": {
      ...
      htmlEdit: {
        ...
        noEditableFields: "这个 HTML 没有可编辑文本字段（需要 data-editable=\"text\" 和 data-id）",
    ...
    "en-US": {
      ...
      htmlEdit: {
        ...
        noEditableFields: "This HTML has no editable text fields (requires data-editable=\"text\" and data-id).",
