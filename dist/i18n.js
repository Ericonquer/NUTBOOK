  ...
  const translations = {
    "zh-CN": {
      ...
      settings: {
        ...
        projectArtifactsDescription: "读取已验证的 Codex 项目记录与 WorkBuddy 任务范围，不进行全盘扫描；确认接入前不会导入任何文件。",
    ...
    "en-US": {
      ...
      settings: {
        ...
        projectArtifactsDescription: "Read verified Codex project records and WorkBuddy task scopes without scanning your entire disk. Nothing is imported before you confirm.",
