  ...
  const translations = {
    "zh-CN": {
      ...
      settings: {
        ...
        defaultAppWindowsOpened: "已在系统设置中打开「默认应用」页面；请在系统页面中将 NUTBOOK 设为 .md / .markdown 的默认应用。",
        defaultAppSetAction: "设为默认",
        defaultAppSetCancelled: "未完成设置（已在系统确认中取消或未授权）。",
        defaultAppSetFailedPrefix: "设置默认应用失败：",
        defaultAppHtmlPendingNote: "HTML：将 NUTBOOK 设为 HTML 文件默认应用的能力将在后续版本提供。",
        defaultAppFallbackHint: "设为默认未完成？可改用 Finder 手动设置。",
        defaultAppFallbackAction: "查看示意图",
        defaultAppFallbackTitle: "备用方法：在 Finder 中设置",
        defaultAppFinderIntro: "在 Finder 中选中一个 Markdown 文件，按以下步骤将 NUTBOOK 设为所有 .md 文件的默认打开方式：",
        defaultAppFinderStep1: "在 Finder 中选中任意一个 .md 文件。",
        defaultAppFinderStep2: "右键该文件，点「显示简介」（快捷键 ⌘I）。",
        defaultAppFinderStep3: "在「打开方式」中选择 NUTBOOK。",
        defaultAppFinderStep4: "点击「全部更改…」，让所有 .md 文件都使用 NUTBOOK。",
    ...
    "en-US": {
      ...
      settings: {
        ...
        defaultAppWindowsOpened: "The system \"Default apps\" page is open; set NUTBOOK as the default app for .md / .markdown there.",
        ...
        defaultAppHtmlPendingNote: "HTML: making NUTBOOK the default app for HTML files is coming in a future version.",
        ...
        defaultAppFinderIntro: "Select a Markdown file in Finder and follow the steps below to make NUTBOOK the default app for all .md files:",
        defaultAppFinderStep1: "Select any .md file in Finder.",
        defaultAppFinderStep2: "Right-click it and choose \"Get Info\" (shortcut ⌘I).",
        defaultAppFinderStep3: "Under \"Open with\", choose NUTBOOK.",
        defaultAppFinderStep4: "Click \"Change All…\" so every .md file opens in NUTBOOK.",
