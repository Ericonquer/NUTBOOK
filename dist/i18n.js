(function () {
  ...
  const translations = {
    "zh-CN": {
      ...
      actions: {
        ...
        copyNbskillInstallPrompt: "复制安装提示",
        scanLibrary: "扫描资料库",
      ...
      settings: {
        ...
        nbskillEnhancement: "NBskill 增强接入：",
        nbskillEnhancementAria: "NBskill 增强接入",
        nbskillEnhancementHint: "安装 nbskill 可增强产物识别，并让支持协议的 HTML 原生可编辑。",
    ...
    "en-US": {
      ...
      actions: {
        ...
        copyNbskillInstallPrompt: "Copy Install Prompt",
      ...
      settings: {
        ...
        nbskillEnhancement: "NBskill Enhancement:",
        nbskillEnhancementAria: "NBskill Enhancement",
        nbskillEnhancementHint: "Install nbskill to improve artifact recognition and enable native editing for supported HTML.",
  ...
  const legacyTextKeys = {
    ...
    "复制安装提示": "actions.copyNbskillInstallPrompt",
