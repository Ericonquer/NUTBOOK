...
fn discover_scope_artifact_summary(
    ...
    let scan_issue = provider_issue.or(observation_issue);
...
fn discover_and_store_candidates(
    ...
    let scan_issue = provider_issue.or(observation.issue.clone());
...
mod tests {
    ...
    use super::{discover_scope_artifact_summary, merge_scope_discovery_payloads};
