...
* Lightweight HTML text and image editing for supported artifacts

* Page navigation for editable presentations and supported vertical HTML
...
* HTML editing is protocol-driven and intended for final content corrections, not arbitrary visual-layout authoring.
